...
#grep -ae "initializeGenomicElement(g3" /nas/longleaf/home/jimarsh/LOGFILES/production5_BGS_midS_lowG_constant.o | sort | uniq > exon5_UTR.temp
#grep -ae "initializeGenomicElement(g4" /nas/longleaf/home/jimarsh/LOGFILES/production5_BGS_midS_lowG_constant.o | sort | uniq >> exon5_UTR.temp
#grep -ae "initializeGenomicElement(g5" /nas/longleaf/home/jimarsh/LOGFILES/production5_BGS_midS_lowG_constant.o | sort | uniq >> exon5_UTR.temp
#sed 's/.*g...//' exon5_UTR.temp | sed 's/,//' | sed 's/).*//' | sort -nk1 > exon5_UTR.txt
#./dfe_productionbox/alphabox/print_nums.sh bin/exon5_UTR.txt | awk '$1 = $1 + 1 {print $0}' > exon5_UTR_pos.txt
