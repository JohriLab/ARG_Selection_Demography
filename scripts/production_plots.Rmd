...
library(patchwork)
library(tidyverse)
setwd(".../ARG/re_recoals")
#setwd(".../ARG/relate_pdf_out/productionbox/production_recoals/")
replicates <- 10
directory <- './'
```
...
setwd(".../ARG/relate_pdf_out/temp10mb/10Mb_recoals/")
...
new <- build_constantplot(
    ...
    title = "Masking Exons/UTRs and conserved % in intron/interg", species = "drosoph")
new
