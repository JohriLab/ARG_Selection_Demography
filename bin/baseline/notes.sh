...
../../relate_v1.1.9_MacOSX_M1/bin/Relate --mode All -m 1.25e-8 -N 40000 --haps bial_test.haps --sample bial_test.sample --map test.map --seed 1 -o bial_test
